...
import { Menu, Building2, LayoutGrid, Users, Package, Bell } from "lucide-react";
...
export function TopBar() {
  ...
  return (
    <div className="flex h-20 items-center justify-between bg-white px-4 md:px-6 border-b-2 border-blue-500">
      <Sheet>
        <SheetTrigger asChild>
          <Button className="h-16 w-16" variant="ghost">
            <Menu className="size-12 text-black" />
          </Button>
        </SheetTrigger>
